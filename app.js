...
// function loader
// ['all'] -- values reference and item - reference value in menu array.

// values.push(item.category)==> ['all', 'breakfast', 'lunch', 'shakes', 'dinner']
...
// display item of menu on screen.
...
function displayMenuBtns() {
  ...
  filterBtns.forEach(function (btn) {
    btn.addEventListener("click", function (e) {
      ...
      //  new array of filter store in menuCategory array;
